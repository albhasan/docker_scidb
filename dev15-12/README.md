...
<ul>
	...
	<li>Log in the container <code>ssh -p 49910 root@localhost</code>. The password is <em>xxxx.xxxx.xxxx</em> for all the users.</li>
...
NOTE: r_exec is deprecated. Use SciDB Stream instead  
